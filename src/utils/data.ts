export const FRIENDS_DATA = [
    { username: 'Shimekato', status: 'online', color: 'orange', id: '1' },
    { username: 'fulldoly1', status: 'offline', color: 'olive', id: '2' },
    { username: 'KDM_Bifors', status: 'offline', color: 'darkviolet', id: '3' },
    { username: 'Fnatic_Flayra', status: 'offline', color: 'darkviolet', id: '4' },
    { username: 'LapuLapu53', status: 'offline', color: 'olive', id: '5' },
    { username: 'RealBillGates', status: 'offline', color: 'darkviolet', id: '6' },
    { username: 'FortniteKid007', status: 'online', color: 'olive', id: '7' },
